angular.module("umbraco")
    ...
    function ($scope, $rootScope, $timeout, dialogService) {
        ...
        if ("value" in $scope.control && $scope.control.value != null) {
            var comArr = eval($scope.control.value.teammember);
            ...
            $scope.control.value = {
                teammember: [
                { 'Name': '', 'imagePath': null,'designation':'', 'id': 1 }
                ],id: 1
            };
            $scope.control.value.Heading = "";
            $scope.control.value.subHeading = "";
            $scope.control.value.vacancy = "";
            $scope.control.value.vacancyURL = "";
        }
        ...
        $scope.AddRow = function () {            
            ...
            $scope.control.value.teammember.push({ 'Name': '', 'imagePath': null, 'designation': '', 'id': $scope.control.value.id });
        };
        ...
        $scope.RemoveRow = function (rowId) {
            ...
            $scope.control.value.teammember.splice(index, 1);
        };
    });
